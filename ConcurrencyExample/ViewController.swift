...
//  ConcurrencyExample
//
//  Created by German Hernandez on 3/10/18.
...
//            id: "image01",
//            defaultData: UIImage(named:
//                "Placeholder")!.pngData()!)
//        asyncData1.delegate = self
//        asyncData1.execute()

//        let asyncData1: Async<Data> =
//            Async<Data>(url: URL(string: imageURL01)!,
//                    id: "image01",
//                    defaultData: UIImage(named:
//                        "Placeholder")!.pngData()!)
...
//        }
        ...
        let asyncData1: Async<AsyncImage> =
            Async<AsyncImage>(url: URL(string: imageURL01)!,
                              id: "image01", defaultData: #imageLiteral(resourceName: "Placeholder.png"))
    ...
    @IBAction func downloadURLSession(_ sender: Any) {
        ...
        // Con request podemos cambiar más cosas, tenemos mayor control
